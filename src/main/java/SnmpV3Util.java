...
public class SnmpV3Util {
    ...
    private static final Map<String /*auth protocol lower case*/, OID /*matched algorithm*/> _authProtocol2OID = new HashMap<String, OID>();
    private static final Map<String /*privacy protocol lower case*/, OID /*matched algorithm*/> _privProtocol2OID = new HashMap<String, OID>();
