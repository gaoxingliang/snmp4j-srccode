...
public class UsmSecurityParameters implements SecurityParameters {
  ...
  public String toString() {
    return "UsmSecurityParameters{" +
            ...
            ", authoritativeEngineBoots=" + authoritativeEngineBoots +
            ", authoritativeEngineTime=" + authoritativeEngineTime +
            ", userName=" + userName +
            ", authenticationProtocol=" + authenticationProtocol +
            ", privacyProtocol=" + privacyProtocol +
            ", authenticationKey=" + Arrays.toString(authenticationKey) +
            ", privacyKey=" + Arrays.toString(privacyKey) +
            ", privacyParameters=" + privacyParameters +
            ", authenticationParameters=" + authenticationParameters +
            ", securityParametersPosition=" + securityParametersPosition +
            ", authParametersPosition=" + authParametersPosition +
