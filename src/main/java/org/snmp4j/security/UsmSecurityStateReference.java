...
public class UsmSecurityStateReference implements SecurityStateReference {
  ...
  public String toString() {
    return "UsmSecurityStateReference{" +
            "userName=" + OctetString.fromByteArray(userName) +
            ...
            ", authenticationKey=" + OctetString.fromByteArray(authenticationKey) +
            ", privacyKey=" + OctetString.fromByteArray(privacyKey) +
